...
export default function ResultTable({ student }) {
  ...
  useEffect(() => {
    ...
    processed = [
      ...
      {
        name: "1st Language",
        fa: subjects.languages[0].fa,
        exam: subjects.languages[0].exam
      },

      {
        name: "2nd Language",
        fa: subjects.languages[1].fa,
        exam: subjects.languages[1].exam
      },

      {
        name: "English",
        fa: subjects.languages[2].fa,
        exam: subjects.languages[2].exam
      },

      {
        name: "Mathematics",
        fa: subjects.mathematics.fa,
        exam: subjects.mathematics.exam
      },

      {
        name: "Science",
        fa: subjects.science.fa,
        exam: scienceExam,
        customResult: scienceResult
      },

      {
        name: "Social Studies",
        fa: subjects.social.fa,
        exam: subjects.social.exam
      }
    ...
    processed = processed.map(sub => {
      ...
      const passMark =
        sub.name.includes("Language") ? 27 : 35;
